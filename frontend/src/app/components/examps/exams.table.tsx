...
import { DeleteTwoTone, EditTwoTone, PlusOutlined, SettingOutlined } from '@ant-design/icons';
import { Button, Card, Descriptions, Flex, Image } from 'antd';
...
const ShowTableExams = (props: IProps) => {
    ...
    const handleClickRow = (record: IExam) => {
        router.push(`/class/${classroom.id}/exams/${record.id}`);
    };
                            ...
                            <Card.Meta
                                avatar={
                                    <Image
                                        ...
                                        alt={templateSelected?.name ?? "Mẫu phiếu thi"}
                                    />
                                }
                                style={{ display: "flex" }}
                                title={e.name}
