    ...
    return (
        <>
            ...
            <aside
                ...
                className={`lg:h-screen fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-[#ffe4e9] shadow-lg transform-gpu transition-transform duration-300 ease-in-out will-change-transform lg:static lg:translate-x-0 lg:shadow-none
                    ${isSidebarOpen
                        ? "translate-x-0"
                        : "-translate-x-full"
                    }
