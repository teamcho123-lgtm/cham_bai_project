...
def read_bubbles(roi_img, cols):
    ...
    for c in contours:
        ...
        if  10 <= area < 350 and 0.4 < aspect_ratio < 1.65 and peri > 40:
            xs.append(x)
            ys.append(y)
            ws.append(w)
            hs.append(h)
...
# img_original  = cv2.imread(r'C:\Users\Admin\Downloads\Project_1\backend\data\ptn2_1.png')

folder = r"C:\Users\Admin\Downloads\Project_1\backend\data\data2 7-2-2026"
image_files = []
